...
class GraphSSLError(TRFormattedError):
...
class GraphConnectionError(TRFormattedError):
    def __init__(self, url):
        super().__init__(
            CONNECTION_ERROR,
            f'Unable to connect Microsoft Graph Security,'
...
class CriticalResponseError(TRFormattedError):
    def __init__(self, response):
        ...
        super().__init__(
            ...
            details.get('message',
                        f'Unexpected response from'
                        f' Microsoft Graph Security: {message}')
        )
